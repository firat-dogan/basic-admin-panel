      ...
      <div class="row">
       <div class="col-md-12">
          <div class="my-3 p-3 bg-white rounded box-shadow">
            <h5 class="card-title p-2">Ekip Listesi <a class="h5 ml-4" href="ekip-kisi-ekle.php">+ Yeni Kişi</a></h5>
		...
		<?php
			...
			<tr>
				 ...
				 <div class="btn-group btn-group-sm">
				   <a href="ekip-kisi-duzenle.php?id='.$row['id'].'" class="btn btn-icon btn-light">İNCELE</a>
